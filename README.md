...
This is an implementation of expanding single variable polynomials with an encoder-decoder model, where the model takes the factorized sequence as input and predict the expanded sequence. 
